<%@page import="com.rays.dto.StudentDTO"%>
...
<%@page import="com.rays.dto.CollegeDTO"%>
<%@page import="com.rays.model.ModelFactory"%>
<%@page import="com.rays.model.CollegeModelInt"%>
...
<body class="p4">
	...
	<div>
		<form action="<%=ORSView.STUDENT_LIST_CTL%>" method="post">
			...
			<jsp:useBean id="dto" class="com.rays.dto.StudentDTO"
